...
public interface AccountServicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return _iceI_openAccountAsync(request, context, true).waitForResponse();
    }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<AccountOpenResponse> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "openAccount", null, sync, null);
